...
pub struct OclVoxelContext {
    ...
    buf_table_keys: Option<Buffer<u64>>,
    buf_table_centroids: Option<Buffer<f32>>,
    buf_table_counts: Option<Buffer<i32>>,
    buf_table_remap: Option<Buffer<i32>>,
    buf_input_points: Option<Buffer<f32>>,
    buf_out_points: Option<Buffer<f32>>,
    buf_valid_count: Option<Buffer<i32>>,
